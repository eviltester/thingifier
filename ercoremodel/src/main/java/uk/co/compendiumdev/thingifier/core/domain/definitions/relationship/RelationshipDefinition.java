...
public class RelationshipDefinition {
    ...
    */
    ...
    public RelationshipDefinition whenReversed(Cardinality of, String named) {
        final RelationshipVectorDefinition vector =
                new RelationshipVectorDefinition(fromTo.getTo(), named, fromTo.getFrom(), of);
    ...
    */
    ...
    public RelationshipVectorDefinition otherVectorOf(
        ...
        System.out.println(
                String.format("Vector %s not part of relationship", relationshipVector.getName()));
        return null;
    }
}
