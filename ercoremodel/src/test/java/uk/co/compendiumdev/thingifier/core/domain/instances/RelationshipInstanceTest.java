...
class RelationshipInstanceTest {
    ...
    void canCreateARelationshipInstance() {
        ...
        EntityInstanceCollection thingfrom =
                new EntityInstanceCollection(new EntityDefinition("from", "from"));
        EntityInstanceCollection thingto =
                new EntityInstanceCollection(new EntityDefinition("to", "to"));
        ...
        final EntityInstance fromInstance =
                thingfrom.addInstance(new EntityInstance(thingfrom.definition()));
        final EntityInstance toInstance =
                thingfrom.addInstance(new EntityInstance(thingfrom.definition()));
        RelationshipVectorInstance rel =
                new RelationshipVectorInstance(vector, fromInstance, toInstance);
        ...
        Assertions.assertFalse(
                rel.involves(thingfrom.addInstance(new EntityInstance(thingfrom.definition()))));
