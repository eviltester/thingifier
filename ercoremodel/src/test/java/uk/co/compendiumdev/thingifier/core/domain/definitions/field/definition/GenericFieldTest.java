...
class GenericFieldTest {
    ...
    void canCreateFieldWithExamples() {
        ...
        final Field field =
                Field.is("complicated", FieldType.STRING).withExample("nuclear physics");

        Assertions.assertEquals(1, field.getExamples().size());

        Assertions.assertEquals("nuclear physics", field.getRandomExampleValue());
    }
    ...
    void randomExamplesReturnsAllExamples() {
        ...
        final Field field =
                Field.is("complicated", FieldType.STRING)
