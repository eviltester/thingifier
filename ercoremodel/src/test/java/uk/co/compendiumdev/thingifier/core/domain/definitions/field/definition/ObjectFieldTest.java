...
class ObjectFieldTest {
    ...
    void canCreateObjectField() {
        ...
        Assertions.assertEquals(
                "Bob", field.getObjectDefinition().getField("firstname").getRandomExampleValue());
    }

    @Test
    void canValidateAtObjectFieldLevel() {

        field.getObjectDefinition().getField("surname").makeMandatory();
    ...
    void canValidateAtObjectFieldLevelWithValidationRules() {
        ...
        Assertions.assertFalse(validation.isValid(), "surname should fail validation");
        Assertions.assertTrue(
                validation.getCombinedErrorMessages().contains("surname : can not be empty"));
    }
    ...
    void canCloneAnObjectField() {
        ...
        Assertions.assertEquals(connieClone.getName(), value.getName());
