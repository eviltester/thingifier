...
class DefinedRelationshipsTest {
    ...
    void canAddRelationship() {
        ...
        Assertions.assertFalse(rels.hasRelationship("bob"));
        ...
        Assertions.assertTrue(rels.hasRelationship("bob"));
    }
    ...
    void canAddAndRetrieveMultipleRelationships() {
        ...
        final RelationshipVectorDefinition bob1 =
                new RelationshipVectorDefinition(
                        new EntityDefinition("thing1", "thing1"),
                        "bob",
                        new EntityDefinition("thing2", "thing2"),
        ...
        final RelationshipVectorDefinition bob2 =
                new RelationshipVectorDefinition(
                        new EntityDefinition("thing2", "thing2"),
                        "bob",
                        new EntityDefinition("thing3", "thing3"),
        ...
        final RelationshipVectorDefinition connie1 =
                new RelationshipVectorDefinition(
                        new EntityDefinition("thing1", "thing1"),
                        "connie",
                        new EntityDefinition("thing2", "thing2"),
        ...
        final RelationshipVectorDefinition dobbs1 =
                new RelationshipVectorDefinition(
                        new EntityDefinition("thing1", "thing1"),
                        "dobbs",
                        new EntityDefinition("thing2", "thing2"),
