...
public class TodosCrudTest {
    ...
    public void canCreateAndAmendSequence() {
        ...
        Assertions.assertFalse(
                response.headers().hasHeaderWithName("X-Thing-Instance-Primary-Key"));
        ...
        Assertions.assertEquals(
                "Could not find an instance with todos/" + specificId,
