...
public abstract class ChallengeCompleteTest {
    ...
    static void alldone() {
        ...
        for (CHALLENGE challenge :
                ChallengeMain.getChallenger().getChallengers().getDefinedChallenges()) {
            if (newChallenger != null && challenge == CHALLENGE.CREATE_NEW_CHALLENGER) {
        ...
        if (remainingChallengeCount - challengesOffset > 0) {
            Assertions.fail(
                    String.format("%d challenges left to complete", remainingChallengeCount));
        }
    ...
    public void canGetTodosPass() {
        ...
        final HttpResponseDetails response = http.send("/todos", "GET", x_challenger_header, "");
    ...
    public void canGetTodosNoAcceptHeaderPass() {
        ...
        Assertions.assertTrue(
                challenger.statusOfChallenge(CHALLENGE.GET_JSON_BY_DEFAULT_NO_ACCEPT));
    }
    ...
    public void canGet404TodoPass() {
        ...
        final HttpResponseDetails response = http.send("/todo", "GET", x_challenger_header, "");
    ...
    public void canHeadTodosPass() {
        ...
        final HttpResponseDetails response = http.send("/todos", "HEAD", x_challenger_header, "");
    ...
    public void canNotPutTodos400ChangeIdAmendPass() {
        ...
        final HttpResponseDetails response =
                http.send(
                        ...
                        headers,
                        String.format(
                                "{\"id\":%d, \"description\":\"my description\"}",
    ...
    public void canPostTodosFailTitleLenValidationPass() {
        ...
        Assertions.assertTrue(
                challenger.statusOfChallenge(CHALLENGE.POST_TODOS_TOO_LONG_TITLE_LENGTH));
    }
    ...
    public void canPostTodosFailDescriptionLenValidationPass() {
        ...
        String twoHundredAndOneChars =
                "*3*5*7*10*13*16*19*22*25*28*31*34*37*40*43*46*49*52*55*58*61*"
        ...
        final HttpResponseDetails response =
                http.send(
                        ...
                        "POST",
                        headers,
                        "{\"title\":\"*3*5*7*9*12*15*18*21*24*27*30*33*36*39*42*45*48*50\",\"description\":\""
        ...
        Assertions.assertTrue(
                challenger.statusOfChallenge(CHALLENGE.POST_TODOS_TOO_LONG_DESCRIPTION_LENGTH));
    }
    ...
    public void canPostTodosWithMaxTitleAndDescriptionLengths() {
        ...
        Assertions.assertEquals(201, response.statusCode);
        Assertions.assertTrue(
                challenger.statusOfChallenge(CHALLENGE.POST_MAX_OUT_TITLE_DESCRIPTION_LENGTH));
    }
    ...
    */
    ...
    public void canNotGetSecretNoteWhenBadAuth403() {
        ...
        final HttpResponseDetails response = http.send("/secret/note", "GET", headers, "");
    ...
    public void canGetSecretNoteWhenBearerAuthToken200() {
        ...
        Assertions.assertEquals(200, response.statusCode);
        Assertions.assertTrue(challenger.statusOfChallenge(CHALLENGE.GET_SECRET_NOTE_BEARER_200));
    }
    ...
    public void canPostSecretNoteWhenAuth200() {
        ...
        // {"note":"bob"}
        final HttpResponseDetails response =
                http.send("/secret/note", "POST", headers, "{\"note\":\"bob\"}");
    ...
    public void canPostSecretNoteWhenBearerAuth200() {
        ...
        Assertions.assertEquals(200, response.statusCode);
        Assertions.assertTrue(challenger.statusOfChallenge(CHALLENGE.POST_SECRET_NOTE_BEARER_200));
    }
    ...
    public void canUseMethodOverrideHeaderToPatch500() {
        ...
        // {"note":"bob"}
        final HttpResponseDetails response = http.send("/heartbeat", "POST", headers, "");

        Assertions.assertEquals(500, response.statusCode);
        Assertions.assertTrue(challenger.statusOfChallenge(CHALLENGE.OVERRIDE_PATCH_HEARTBEAT_500));
    }
    ...
    public void canUseMethodOverrideHeaderToDelete405() {
        ...
        Assertions.assertEquals(405, response.statusCode);
        Assertions.assertTrue(
                challenger.statusOfChallenge(CHALLENGE.OVERRIDE_DELETE_HEARTBEAT_405));
    }
    ...
    public void canUseMethodOverrideHeaderToTrace501() {
        ...
        Assertions.assertEquals(501, response.statusCode);
        Assertions.assertTrue(challenger.statusOfChallenge(CHALLENGE.OVERRIDE_TRACE_HEARTBEAT_501));
    }
    ...
    public void canCreateANewChallenger() {
        ...
        newChallenger =
                ChallengeMain.getChallenger().getChallengers().getChallenger(challengerCode);

        Assertions.assertTrue(newChallenger.statusOfChallenge(CHALLENGE.CREATE_NEW_CHALLENGER));
    }
    ...
    public void canGetChallengerToRestorePass() {
        ...
        Assertions.assertEquals(200, response.statusCode);
        Assertions.assertTrue(
                challenger.statusOfChallenge(CHALLENGE.GET_RESTORABLE_CHALLENGER_PROGRESS_STATUS));
    }
    ...
    public void canGetTodosDatabaseToRestorePass() {
        ...
        final HttpResponseDetails response =
                http.send(
                        "/challenger/database/" + challenger.getXChallenger(),
                        "GET",
                        x_challenger_header,
                        "");
    ...
    public void canRestoreTodosDatabaseToPass() {
        ...
        //        final HttpResponseDetails response =
        //                http.send("/challenger/database/" + challenger.getXChallenger(), "GET",
        // x_challenger_header, "");
