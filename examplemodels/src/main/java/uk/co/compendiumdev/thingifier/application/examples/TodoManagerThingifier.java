...
public class TodoManagerThingifier {
    ...
    */
    ...
    public Thingifier get(final EntityRelModel entityRelModel) {
        ...
        // TODO: create validation rule MatchesFieldType to allow configuration of field validation
        // against type
        // TODO: ValidationRule Interface - implemented by rules and ValidtionRuleGroup to allow
        // processing in a list - main method validates()
        ...
        // TODO create a ValidationRuleGroup.and()  where all the validation rules in the group must
        // pass for validation to pass
        // TODO create a ValidationRuleGroup.or()  where any of the validation rules in the group
        // must pass for validation to pass - stops on first 'pass'
        // TODO : create a MatchesRegex validation rule for fields - this will be the simplest way
        // of creating complex validation quickly
        // e.g. (.|\s)*\S(.|\s)*    non empty
        ...
        project.addFields(
                ...
                Field.is("active", FieldType.BOOLEAN).withDefaultValue("false"),
                Field.is("description", STRING));
        ...
        // PROFILES
        // can have different -version params which configure the TodoManagerThingifier in different
        // ways
        ...
        ThingifierApiConfigProfile profile0 =
                todoManager.apiConfigProfiles().create("v0", "prototype");
        ...
        ThingifierApiConfigProfile profile2 =
                todoManager.apiConfigProfiles().create("v2", "compressed relationships with guids");
        ...
        ThingifierApiConfigProfile profile3 =
                todoManager.apiConfigProfiles().create("v3", "compressed relationships with ids");
