...
public class TodoListThingifierTestModel {
    ...
    */
    public Thingifier get() {
        ...
        ThingifierApiConfigProfile profilev0 =
                todoList.apiConfigProfiles().create("0", "v0 prototype");
        ...
        ThingifierApiConfigProfile profilev1 =
                todoList.apiConfigProfiles().create("1", "v1 single as plural");
        ...
        ThingifierApiConfigProfile profilev2 =
                todoList.apiConfigProfiles()
                        .create("2", "v2 no id header, improved output validation");
        ...
        ThingifierApiConfigProfile profilev3 =
                todoList.apiConfigProfiles().create("3", "v3 use ids in headers and validation");
