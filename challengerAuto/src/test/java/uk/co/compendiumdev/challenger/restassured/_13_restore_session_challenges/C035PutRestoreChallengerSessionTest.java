...
public class C035PutRestoreChallengerSessionTest extends RestAssuredBaseTest {
    ...
    public void canPutChallengerSessionToReset() {
        ...
        Challenger newChallengerResponse =
                new Gson().fromJson(nResponse.body().asString(), Challenger.class);
        ...
        Assertions.assertTrue(
                statuses.getChallengeNamed("PUT /challenger/guid RESTORE").status,
