...
public class RepositoryRouteQuery implements RepositoryQueryResult {
    ...
    public RepositoryRouteQuery(final ERSchema schema, final ThingStore store, final String route) {
        this.schema = schema;
        this.store = store;
        this.route = route;
    }
    ...
    public RepositoryRouteQuery performQuery() {
        return performQuery(new QueryFilterParams());
    }

    public RepositoryRouteQuery performQuery(final QueryFilterParams queryParams) {
