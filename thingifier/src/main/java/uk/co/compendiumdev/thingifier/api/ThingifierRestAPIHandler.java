...
public class ThingifierRestAPIHandler {
    ...
    public ApiResponse get(final String url, final QueryFilterParams queryParams, Map<String, String> headers) {
        return get.handle(url, queryParams, headers);
    }

    public ApiResponse head(final String url, final QueryFilterParams queryParams, Map<String, String> headers) {
