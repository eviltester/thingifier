...
public class TodoManagerModel {
    ...
    */
    ...
    // TODO: allow definition of unique scheme e.g. id starting at 0 auto increment (GUID is global,
    // ID is per entity)
    ...
    public static Thingifier definedAsThingifier() {
        ...
        para.append(
                "Set Content-Type header to application/xml if you want to send in XML.<br/>\n");
        ...
        para.append(
                "&#x3C;project&#x3E;&#x3C;title&#x3E;My posted todo on the project&#x3C;/title&#x3E;&#x3C;/project&#x3E;<br/>\n");
        ...
        // TODO create mandatory relationships = at the moment all entities can exist without
        // relationship
        ...
        estimate.addFields(
                Field.is("duration", INTEGER).makeMandatory().withValidation(VRule.notEmpty()),
                Field.is("description", STRING));

        // a todo can only have one estimate, and an estimate is for one todo
        final RelationshipDefinition estimated =
                todoManager
                        .defineRelationship(estimate, todo, "estimate", Cardinality.ONE_TO_MANY())
        ...
        // TODO there is a special case of Mandatory : Mandatory which we need to be able to
        // 'create' entities at same time as relationships
