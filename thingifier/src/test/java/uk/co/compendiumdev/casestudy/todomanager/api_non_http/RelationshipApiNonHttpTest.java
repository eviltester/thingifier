    ...
    */
    ...
    public void getCanReturnInstancesOfARelationship() {
        ...
        todoManager
                .getStore(EntityRelModel.DEFAULT_DATABASE_NAME)
                .relationships()
                .connect(myNewProject, "tasks", paperwork);

        int numberOfTasks =
                todoManager
                        .getStore(EntityRelModel.DEFAULT_DATABASE_NAME)
                        .relationships()
                        .listRelated(myNewProject, "tasks")
                        .size();
        ...
        EntityInstance foundInstance =
                todoManager
                        .getStore(EntityRelModel.DEFAULT_DATABASE_NAME)
                        .entityQueries()
                        .findByField(todo, "guid", paperwork.getPrimaryKeyValue());
    ...
    public void postCanCreateARelationshipAndTodoAtSameTimeUsingAPI() {
        ...
        EntityInstance myCreatedTodo =
                todoManager
                        .getStore(EntityRelModel.DEFAULT_DATABASE_NAME)
                        .entityQueries()
                        .findByPrimaryKey(todo, locationGuid);
        ...
        Collection<EntityInstance> items =
                todoManager
                        .getStore(EntityRelModel.DEFAULT_DATABASE_NAME)
                        .relationships()
                        .listRelated(myCreatedTodo, "task-of");
    ...
    public void postCanCreateAMandatoryRelationshipFromEstimateAndTodoAtSameTimeUsingAPI() {
        ...
        EntityInstance myCreatedItem =
                todoManager
                        .getStore(EntityRelModel.DEFAULT_DATABASE_NAME)
                        .entityQueries()
                        .findByPrimaryKey(estimates, locationGuid);
        Assertions.assertEquals(
        ...
        Collection<EntityInstance> items =
                todoManager
                        .getStore(EntityRelModel.DEFAULT_DATABASE_NAME)
                        .relationships()
                        .listRelated(myCreatedItem, "estimate");
        Assertions.assertEquals(
