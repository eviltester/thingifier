...
public class ThingifierHttpApiRequestHandlingTest {
    ...
    public void aGetRequestWillCreateNewSessionWithDatabase(){
        ...
        // add a thing
        final EntityDefinition thing = thingifier.getERmodel().getSchema().getDefinitionWithSingularOrPluralNamed("thing");
        final EntityInstance existingInstance = thingifier.getRepository("other_things").createInstance(EntityInstanceDraft.forEntity(thing).withField("title", "My Title" + System.nanoTime()));
    ...
    public void aRequestWillCreateNewSessionWithDatabaseUsingDefaultData(){
        ...
        RepositoryDataPopulator dataPopulator = (schema, repository) -> {
            ...
            for(String thingTitle : titles){
                repository.createInstance(EntityInstanceDraft.forEntity(thing).withField("title", thingTitle));
            }
        };
        ...
        Assertions.assertEquals(3, thingifier.getRepository("other_things").countInstances(thingInstances));
    }
    ...
    public void aPostRequestWillCreateNewSessionWithDatabase(){
        ...
        Assertions.assertEquals(1, thingifier.getRepository("other_things").countInstances(thingInstances));
    ...
    public void aDeleteRequestWillCreateNewSessionWithDatabase(){
        ...
        EntityInstance anInstance =
                thingifier.getRepository("other_things").createInstance(EntityInstanceDraft.forEntity(thingInstances));
        ...
        Assertions.assertEquals(0, thingifier.getRepository("other_things").countInstances(thingInstances));
