...
public class ApiResponseAsXml {
    ...
    public ApiResponseAsXml(ApiResponse apiResponse) {
    ...
    public static String getErrorMessageXml(String errorMessage) {
    ...
    public static String getErrorMessageXml(Collection<String> myErrorMessages) {
